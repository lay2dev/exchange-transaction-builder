...
exports.ExchangeLockSigner = void 0;
...
class ExchangeLockSigner extends pw_core_1.Signer {
    constructor(fromAddr, singlePrivateKey, multiPrivateKey, threshold, requestFirstN, signFlag, hasher) {
        super(hasher);
...
exports.ExchangeLockSigner = ExchangeLockSigner;
