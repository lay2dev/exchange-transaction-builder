...
exports.ExchangeLockMultiTxBuilder = void 0;
const pw_core_1 = require("@lay2/pw-core");
const config_1 = require("../config");
const deploy_1 = require("../deploy/deploy");
class ExchangeLockMultiTxBuilder extends pw_core_1.Builder {
    ...
    build() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const neededAmount = this.amount.add(pw_core_1.Builder.MIN_CHANGE).add(this.fee);
            ...
            let rawTx = new pw_core_1.RawTransaction(inputCells, [outputCell, changeCell], [
            ...
            const tx = new pw_core_1.Transaction(rawTx, [this.witnessArgs]);
...
exports.ExchangeLockMultiTxBuilder = ExchangeLockMultiTxBuilder;
