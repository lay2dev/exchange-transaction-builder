...
exports.ExchangeLockFromTimeLock = void 0;
...
class ExchangeLockFromTimeLock {
    constructor(fee = pw_core_1.Amount.ZERO, amount, threshold, requestFirstN, singlePrivateKey, multiPrivateKey, nodeUrl, feeRate, collector) {
        ...
        let toAddr = pw_core_1.Address.fromLockScript(exchangeLockScript);
        ...
        blake.reset();
        const fromAddr = pw_core_1.Address.fromLockScript(timeLockScript);
        const witnessArgs = {
            lock: new pw_core_1.Reader(TimeLock.SerializeLock({
                args: {
                    threshold: this.threshold,
                    request_first_n: this.requestFirstN,
                    multi_pubkey: multiPubKeyHash,
        ...
        this.builder = new builder_1.ExchangeLockFromTimeLockBuilder(fromAddr, toAddr, this.fee, this.amount, witnessArgs, this.feeRate, this.collector);
        this.signer = new signer_1.TimeLockSigner(fromAddr, singlePrivateKey, multiPrivateKey, threshold, requestFirstN, false, exchangeLockScriptHash, new pw_core_1.Blake2bHasher());
    }
    send() {
...
exports.ExchangeLockFromTimeLock = ExchangeLockFromTimeLock;
