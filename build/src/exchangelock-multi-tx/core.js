...
class ExchangeLockMultiTx {
     ...
     */
    static create(fromOutPoint, adminLockScript, threshold, requestFirstN, singlePubKey, multiPrivateKey, config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const singlePubKeyHash = new pw_core_1.Reader(new pw_core_1.Blake2bHasher()
                ...
                .toArrayBuffer()
                .slice(0, 20));
            let exchangeLock = new ckb_exchange_lock_1.ExchangeLock(new ckb_exchange_lock_1.ExchangeLockArgs(threshold, requestFirstN, singlePubKeyHash, multiPubKeyHash), 1, []);
            ...
            const signer = new exchange_lock_signer_1.ExchangeLockMultiSigner(inputCell.lock.toHash(), multiPrivateKey, exchangeLock.clone(), new pw_core_1.Blake2bHasher());
            const builder = new builder_1.ExchangeLockMultiTxBuilder(inputCell, outputCell, exchangeLock, [
            ...
            return yield new ExchangeLockMultiTx(rpc, builder, signer);
        });
    }
    /**
